...
const SOCIAL_LINKS = [
  { icon: Github, link: "htt" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/melani-uthpala" },
  { icon: Instagram, link: "https://www.instagram.com/_zach_iii_?igsh=MTVub2VqNXczenkzMg==" }
];

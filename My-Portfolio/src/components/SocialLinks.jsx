...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/melani-uthpala",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "_zach_iii_",
    icon: Instagram,
    url: "https://www.instagram.com/_zach_iii_?igsh=MTVub2VqNXczenkzMg==",
    color: "#E4405F",

...
const AboutPage = () => {
  ...
  const statsData = useMemo(() => [
    ...
    },
    {
      ...
      label: "Certificates",
      description: "skills and achievements",
      animation: "fade-up",
    },
    {
      icon: Globe,
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             I'm passionate software developer with a strong interest in front-end development and modern web technologies. I focus on creating engaging digital experiences and always strive to deliver the best solutions in every project I work on. 
            </p>
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Leveraging AI as a professional tool, not a replacement."
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/drive/folders/1o8vNP-nDGHZjqp4MhLdbUkCgmCnqDsvq" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
